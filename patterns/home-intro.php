<?php
/**
 * Title: Homepagina — welkomsttekst
 * Slug: la-randulina/home-intro
 * Categories: la-randulina
 * Description: De kop, subkop en introductietekst zoals aangeleverd door de klant.
 *
...
<section class="lr-binnen lr-intro">
	...
	<p><?php esc_html_e( 'Door onze ligging zijn we ook de perfecte tussenstop onderweg van of naar Italië. Blijf één nacht om op te laden, of een paar dagen langer om de omgeving te ontdekken. Terwijl jij geniet van een ongedwongen avond en een goed bed, laadt je auto kosteloos op aan ons eigen laadstation.', 'la-randulina' ); ?></p>
